...
public class CustomerController {
    ...
    @GetMapping("/{id}")
    public DataResponse<ObjectNode> getCustomer(@PathVariable("id") Long id, @RequestParam(required = false) List<String> fields) {

        log.info("{}", fields);
        ObjectNode customer = customerService.getCustomer(id, fields);
